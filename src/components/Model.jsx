      ...
      <div className="screen-max-width   ">
        ...
        <div className=" flex flex-col items-center mt-5">
          ...
          >
            ...
            >
              {/*this view port is used to render multiple view in same canvas  */}
              <View.Port />
            </Canvas>
          </div>

          {/* this div use to show the title ,size etc  */}
